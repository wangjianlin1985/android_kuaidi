...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  /*绑定该view各个控件*/
	  holder.tv_companyId = (TextView)convertView.findViewById(R.id.tv_companyId);
	  holder.tv_companyName = (TextView)convertView.findViewById(R.id.tv_companyName);
	  /*设置各个控件的展示内容*/
	  holder.tv_companyId.setText("公司id：" + mData.get(position).get("companyId").toString());
	  holder.tv_companyName.setText("公司名称：" + mData.get(position).get("companyName").toString());
	  /*返回修改好的view*/
	  return convertView; 
    } 
